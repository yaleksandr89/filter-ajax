            ...
            <div class="col-md-12">
                <div id="app" class="mx-auto">
                    ...
                    <div class="txt">
                        ...
                        <p>Если вы уверны в обратном, пожалуйста свяжитесь со мной<span class="blink">_</span></p>
                        <form class="form-group text-center">
                            <button type="button" class="btn btn-outline-secondary" onclick="location.href='/'">
                                Вернуться на главную
                            </button>
                            <button type="button" class="btn btn-outline-warning"
                                    onclick="location.href='mailto:yaleksandr89@gmail.com?subject=Письмо%20с%20сайта%20(Ошибка%20404)&body=Здравствуйте!'">
                                Написать письмо
                            </button>
                        </form>
                        <p class="mt-5">Автоматическая переадресация на главную через <span class="timer">10</span></p>
                    </div>
                </div>
            </div>
        </div>
