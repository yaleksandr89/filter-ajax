...
## Descripción:
El proyecto implementa la filtración de productos por categoría, color y peso utilizando solicitudes asíncronas sin bibliotecas adicionales en JavaScript nativo. El framework CSS Bootstrap 5.3 se utiliza para el estilo, con un interruptor entre temas claro y oscuro implementado en la plantilla. En el directorio `docs/examples/` encontrarás dos archivos:
