...
<head>
    ...
    <link href="/assets/css/navbar-static.css" rel="stylesheet">
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
        <div class="container-fluid">
            <a class="navbar-brand" href="#" aria-label="logotype">
                <img src="/assets/logotype.png" width="50" height="50" alt="Aleksandr Yurchenko • Logotype">
            </a>
...
<main class="container">
    <div class="row">
        <div class="col-md-12">
            <h1 class="animate-txt text-center"><?= $this->escape($title) ?></h1>
            <?= $content ?>
        </div>
    </div>
</main>
